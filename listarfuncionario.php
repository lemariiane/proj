...
$agendamentos = $dao->listarAgendamentos(); // Para agendamentos de cirurgia
?>
...
<div class="menu">
    ...
    <div class="signup-link">
        <a href="novoCadastro.php">Novo funcionário Informática</a>
    </div>
    <div class="signup-link">
        <a href="novoNumcar.php">Novo funcionário Agendamento de Cirurgia</a>
    </div>
    <div class="signup-link">
